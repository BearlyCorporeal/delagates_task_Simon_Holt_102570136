...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Holt/Documents/GitHub/delagates_task_Simon_Holt_102570136/datacsv.csv";  // change to appropriate path
        private string _tsvPath = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Holt/Documents/GitHub/delagates_task_Simon_Holt_102570136/datatsv.tsv";  // change to appropriate path

        private string _writeFile = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Holt/Documents/GitHub/delagates_task_Simon_Holt_102570136/writefiletsv.tsv";  // change to appropriate path
