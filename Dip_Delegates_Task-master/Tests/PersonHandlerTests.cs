...
namespace PersonHandlerTests
{
    public class PersonHandlerTests
    {
        ...
        private string csvPath = Environment.GetEnvironmentVariable("HOME") + "C:/Users/Holt/Documents/GitHub/delagates_task_Simon_Holt_102570136/datacsv.csv"; // change to appropriate path
